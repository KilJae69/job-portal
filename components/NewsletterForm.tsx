...
import { newsletterSchema, TNewsletterFormSchema } from "@/lib/newsletterSchema";
      ...
      <div className="relative mt-6">
        ...
        <div className="absolute inset-y-1 right-1 flex justify-end">
          <button
            ...
            className="flex aspect-square h-full items-center justify-center cursor-pointer rounded-xl bg-accent text-white transition hover:bg-accent/90"
          >
            {isSubmitting ? (
